...
import com.example.viewmodelandlivedata.Mainviewmodel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Connecting the count_textView with count_tv TextView Instance
    ...
    {
        mvm.doIncrement();                              // reducing the current value by 1
        //count_tv.setText(String.valueOf(mvm.count));// Setting the value of Count on the count textview on UI.
    ...
    {
        mvm.doDecrement();                                 // reducing the current value by 1
        //count_tv.setText(String.valueOf(mvm.count)); // Setting the value of Count on the count textview on UI.
        // String.value() - converts the type of count value from Integer to String
    }
}